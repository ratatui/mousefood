...
- Release 0.5.2 ([#207](https://github.com/ratatui/mousefood/issues/207))
...
- *(colors)* Add monochrome grayscale conversions ([#226](https://github.com/ratatui/mousefood/issues/226))
...
- *(ci)* Cache correctly in "Check formatting" and "Run clippy" ([#190](https://github.com/ratatui/mousefood/issues/190))

### 📚 Documentation

- *(readme)* Add MaraTUI to projects list ([#206](https://github.com/ratatui/mousefood/issues/206))
